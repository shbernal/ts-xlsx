...
- **Still open, and deliberately so:** do we measure MDW from actual font metrics, which requires
  font metric data for common faces, or carry width as an opaque round-trippable value and only
