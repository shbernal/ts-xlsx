...
```ts
class Column extends AxisHandle<ColumnProperties> {
...
[`MAX_COLUMN_WIDTH`](./grid-limits.md#maxcolumnwidth) bounds what Excel accepts being set, not what a file may hold. Excel
