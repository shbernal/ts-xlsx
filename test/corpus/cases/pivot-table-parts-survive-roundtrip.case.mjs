  ...
  behavior: [
    {
      ...
      async expect(api, assert) {
        ...
        assert.strictEqual(rewritten.pivotTables, source.pivotTables, `all ${source.pivotTables} pivot table parts survive`);
      },
    },
    {
      ...
      async expect(api, assert) {
        ...
        assert.strictEqual(rewritten.pivotCache, source.pivotCache, `all ${source.pivotCache} pivot cache parts survive`);
      },
    },
  ],
};
