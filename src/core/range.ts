...
// a plain data record of strings, numbers, booleans and nested records, with no functions, no
// cycles and no class instances, which is exactly the shape JSON round-trips faithfully.
//
