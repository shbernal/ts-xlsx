...
// The default Office theme (colour scheme, font scheme, and format scheme). The
// stylesheet's default font references `theme="1"`, which a consumer can only resolve
// against this part — so the two ship together.
export const THEME1_XML =
  XML_DECLARATION +
